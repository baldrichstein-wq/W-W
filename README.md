# W-W
Ein atmosphärisches Dungeon-Crawler RPG für den Browser und das Handy.

## 🎮 Spielübersicht
W-W ist ein textbasiertes Rollenspiel mit grafischen Elementen, in dem du eine Gruppe von bis zu vier Helden durch 15 gefährliche Ebenen eines Dungeons führst. Kämpfe gegen Monster, löse Rätsel, erfülle Quests und entwickle deine Charaktere zu legendären Spezialisten.

## 🚀 Hauptmerkmale & Mechaniken

### 1. Fortschrittliches Skill-System
...
*   **Schurke:** Assassine (+Krit) oder Schattenläufer (+Stealth).
*   **Und viele weitere:** Heiler, Verteidiger, Barde, Tüftler und Alchemist haben jeweils zwei einzigartige Pfade mit **passiven Boni**.

#### Übersicht der Spezialisierungen

| Basisklasse | Spezialisierung | Passiver Bonus |
| :--- | :--- | :--- |
| **Krieger** | Paladin | +2 Schadensreduktion pro Treffer |
| | Berserker | +3 Angriff (ATK) |
| **Magier** | Erzmagier | +2 AP-Regeneration pro Runde |
| | Nekromant | +20 Maximale HP |
| **Schurke** | Assassine | Kritische Treffer sind leichter zu erzielen (-1 Schwelle) |
| | Schattenläufer | +5 Stealth (Verstohlenheit) |
| **Heiler** | Hohepriester | +15% Heilungseffektivität |
| | Inquisitor | +2 Angriff (ATK) |
| **Verteidiger** | Wächter | +3 Schadensreduktion pro Treffer |
